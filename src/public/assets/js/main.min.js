...
$('.form-cart-item-update').on('submit', function(event) {
...
$('.form-add-to-cart').on('submit', function(e) {
  ...
  $.ajax({
    ...
    success: function() {
      confirm('Sản phẩm đã được thêm vào giỏ hàng')
      location.reload();
...
// $('.form-apply-coupon').on('submit', function(e) {
//   e.preventDefault();
...
$('.btn-clear-shopping-cart').on('click', (e) => {
  e.preventDefault();
  if (confirm("Xóa hết sản phẩm trong giỏ hàng")) {
    $.ajax({
      url: '/cart',
      type: 'DELETE',
      data: {
